...
const CheckoutForm : React.FunctionComponent<Props> = (props: Props) => {
  ...
  const onChange = (propertyName: string, e: React.ChangeEvent<HTMLInputElement>) => {
    const newForm: Data = { ...data };
    newForm[propertyName] = e.target.value;
    setData(newForm);
  };
